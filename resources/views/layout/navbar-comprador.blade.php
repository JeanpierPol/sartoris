    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <li class="nav-item dropdown d-flex mr-4">
        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          @else
          <img src="https://lh3.googleusercontent.com/drive-viewer/AKGpihYVKuxiNrVgjma-ISqJ1CRZHQZ-Z4Jk5BCxJ6ze627neDniNHfyaO6qcSS6oiOb9oNKppBOJkzBbUrtSZ_5APBo_ALXPvzMH24=w1920-h965-rw-v1" width="40" height="40" class="rounded-circle" />
          @endif
        </a>
        <ul class="dropdown-menu dropdown-menu-lg-end">
