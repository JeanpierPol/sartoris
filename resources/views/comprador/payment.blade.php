...
<style>
    ...
    .card {
        width: 100%;
        max-width: 390px; /* Tamaño máximo para pantallas grandes */
        height: auto;
        border-radius: 10px;
    ...
    @media screen and (max-width: 992px) {
        .card {
            max-width: 100%; /* Utiliza el 100% del ancho en tablets */
        }
    }
    ...
    @media screen and (max-width: 768px) {
        .card {
            max-width: 100%; /* Utiliza el 100% del ancho en dispositivos móviles */
        }
    }
</style>
